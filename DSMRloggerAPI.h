...
bool        bTapMonitor = false;
bool        P1Out = false;
bool        bNewTelegramWebhook = false;
bool        bNewTelegramTap = false;
bool        bV5meter = true;
...
uint16_t  settingTapInterval = 10;
bool      bTimeFromNtp = false;
char      settingTimezone[48] = "CET-1CEST,M3.5.0,M10.5.0/3";
